...
# When somebody requests a page from your Web site – say, “/polls/34/”, Django will load the mysite.urls Python module because it is pointed to by the ROOT_URLCONF setting. 
...
# Note that the regular expressions for the include() functions do not have a $ (end-of-string match character) but rather a trailing slash. 
